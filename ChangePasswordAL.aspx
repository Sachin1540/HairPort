<%@ Page Language="C#" MasterPageFile="~/MasterAL.master" AutoEventWireup="true" CodeFile="ChangePasswordAL.aspx.cs" Inherits="Default2" Title="Change Password" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <td> <asp:CompareValidator ID="CompareValidator1" runat="server" 
        ...
        <asp:RequiredFieldValidator
            ...
            ErrorMessage="Re-Type Password" ControlToValidate="txtRetypePass" 
